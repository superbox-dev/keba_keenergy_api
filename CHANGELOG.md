...
- Add endpoints to read the energy management data from the API

## [1.14.0] - 2025-08-27

### Added

- Add `has_room_temperature()` and `has_room_hummidity()` endpoint for heat circuits
...
- Add [py.typed](keba_keenergy_api/py.typed) to support static type checking e.g. with mypy
